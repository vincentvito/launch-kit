// Inline SVG icons for the shipdaddy waitlist. Plain presentational components
// (no client boundary) so they can be used from both the server shell and the
// interactive client island.
import type { CSSProperties } from 'react'

export function Sparkle({ size = 14, style }: { size?: number; style?: CSSProperties }) {
  return (
